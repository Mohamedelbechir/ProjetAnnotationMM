	...
	<div id="sidebar-left" class="span2">
		<div class="nav-collapse sidebar-nav">
			<ul class="nav nav-tabs nav-stacked main-menu">
				...
				<li><a href="documents.php"><i class="icon-tasks"></i><span class="hidden-tablet">Liste des document</span></a></li>
				<li><a href="images.php"><i class="icon-tasks"></i><span class="hidden-tablet"> Liste des images</span></a></li>
				<li><a href="videos.php"><i class="icon-tasks"></i><span class="hidden-tablet"> Liste des Video</span></a></li>
