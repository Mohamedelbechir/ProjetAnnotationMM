<?php
	...
	get_bread_two();
?>
<a type="button" href="add_new_document.php" class="btn btn-success btn-block">Ajouter un document</a>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php
								...
								$result = mysqli_query($con,"SELECT * FROM tbldocument ");
							...
							<tr>
								...
								<td><?php echo $row['txtfilename']; ?></td>
								<td class="center">
